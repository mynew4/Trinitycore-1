...
class bot_ai : public ScriptedAI
{
    ...
    protected:
        ...
        virtual void removeFeralForm(bool /*force*/ = false, bool /*init*/ = true, uint32 const /*diff*/ = 0) {}
        ...
        virtual void CureGroup(Player* /*pTarget*/, uint32 /*cureSpell*/, uint32 const /*diff*/) {}
        virtual void CheckAuras(bool /*force*/ = false) {}
        virtual void BuffAndHealGroup(Player* /*gPlayer*/, uint32 const /*diff*/) {}
        ...
        //virtual void CommonTimers(uint32 const diff) = 0;
        ...
        virtual bool CureTarget(Unit* /*target*/, uint32 /*cureSpell*/, uint32 const /*diff*/) { return false; }
...
class bot_minion_ai : public bot_ai
{
    public:
        ...
        bool CureTarget(Unit* target, uint32 cureSpell, uint32 const diff);
    ...
    protected:
        ...
        virtual void BreakCC(uint32 const diff);

        void CommonTimers(uint32 const diff)
        {
    ...
    private:
        bool CanCureTarget(Unit* target, uint32 cureSpell, uint32 const diff) const;
