...
void PlayerbotShamanAI::UpdateGroupActions(uint32 const diff)
{
    ...
    {
        //sLog->outError("PlayerbotShamanAI:: %s has found unenchanted mainhand weapon %s", me->GetName().c_str(), weapon->GetTemplate()->Name1.c_str());
        switch (spec)
        {
            case SHAMAN_SPEC_RESTORATION:
                if (EARTHLIVING_WEAPON)
                {
                    ...
                    //sLog->outError("PlayerbotShamanAI:: %s tries to enchant with Earthliving", me->GetName().c_str());
                }
                break;
            case SHAMAN_SPEC_ELEMENTAL:
                if (FLAMETONGUE_WEAPON)
                {
                    ...
                    //sLog->outError("PlayerbotShamanAI:: %s tries to enchant with Flametongue", me->GetName().c_str());
                }
                break;
            case SHAMAN_SPEC_ENHANCEMENT:
                if (WINDFURY_WEAPON)
                {
                    ...
                    //sLog->outError("PlayerbotShamanAI:: %s tries to enchant with Windfury", me->GetName().c_str());
                }
                else if (FROSTBRAND_WEAPON)
                {
                    m_ai->CastSpell(weapon, FROSTBRAND_WEAPON);
                    //sLog->outError("PlayerbotShamanAI:: %s tries to enchant with Frostbrand", me->GetName().c_str());
                }
                break;
            default:
                break;
