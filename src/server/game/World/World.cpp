...
void World::LoadConfigSettings(bool reload)
{
    ...
    rate_values[BUFF_RATE_XP_EXPLORE]  = ConfigMgr::GetFloatDefault("BUFF_Rate.XP.Explore", 1.0f);
    ...
    rate_values[RATE_PET_HP] = ConfigMgr::GetFloatDefault("RATE_PET_HP", 1.0f);
    rate_values[RATE_PET_ARMOR] = ConfigMgr::GetFloatDefault("RATE_PET_ARMOR", 1.0f);
    rate_values[RATE_PET_ATT] = ConfigMgr::GetFloatDefault("RATE_PET_ATT", 1.0f);
