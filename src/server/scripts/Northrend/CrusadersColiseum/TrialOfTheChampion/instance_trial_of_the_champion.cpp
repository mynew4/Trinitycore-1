...
/* ScriptData
Author: Trinitycore ,edited by MadMan e sandro
...
public:
    ...
    struct instance_trial_of_the_champion_InstanceMapScript : public InstanceScript
    {
		...
		/*
				  ...
				  Inserisco dei nuovi controlli in caso di creazione Creature dello script in maniera tale da risolvere lo spawn di Boss orda 
				  in caso di party ally
				*/
